...
define config.name = _("NARSPI the Novella")
...
define gui.about = _p("""
Игра основана на поэме Константина Иванова - "Нарспи"

Разработчик - @AHeroWith2Arms
Дизайнер - @AHeroWith2Arms
Менеджер проекта - @AHeroWith2Arms

Отдельное спасибо нужно выразить Владимиру Михайлову за дизайн главного меню.
...
define build.name = "NARSPItheNovella"
...
define config.save_directory = "NARSPItheNovella-1742329069"
